...
public class RouteController {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "201", description = "Route created successfully", content = @Content(schema = @Schema(implementation = RouteResponse.class))),
                        @ApiResponse(responseCode = "400", description = "Invalid input data"),
                        @ApiResponse(responseCode = "404", description = "Ticket rule not found")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Route deactivate successfully"),
                        @ApiResponse(responseCode = "404", description = "Route not found")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Route activate successfully"),
                        @ApiResponse(responseCode = "404", description = "Route not found")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Route retrieved successfully", content = @Content(schema = @Schema(implementation = RouteResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Route not found")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "201", description = "Stations added to route successfully", content = @Content(schema = @Schema(implementation = RouteResponse.class))),
                        @ApiResponse(responseCode = "404", description = "Route or station not found"),
                        @ApiResponse(responseCode = "400", description = "Station already exists in route or invalid data")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Route stations updated successfully"),
                        @ApiResponse(responseCode = "404", description = "Route or station not found")
        })
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "All stations removed from route successfully"),
                        @ApiResponse(responseCode = "404", description = "Route not found")
        })
        ...
        @GetMapping("/summary")
        @Operation(summary = "Get all routes summary", description = "Get id and name of all routes")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Routes summary retrieved successfully")
        })
        public ResponseApi<List<RouteSummaryResponse>> getAllRouteSummary() {
                return ResponseApi.<List<RouteSummaryResponse>>builder()
                                .status(HttpStatus.OK.value())
                                .message("Routes summary retrieved successfully")
                                .data(routeService.getAllRouteSummary())
                                .build();
        }

        @GetMapping("/id")
        @Operation(summary = "Get all route IDs", description = "Get only IDs of all routes")
        public ResponseApi<List<Long>> getAllIdOfRoute() {
                return ResponseApi.<List<Long>>builder()
                                .status(HttpStatus.OK.value())
                                .message("Route IDs retrieved successfully")
